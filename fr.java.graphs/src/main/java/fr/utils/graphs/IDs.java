...
public class IDs {
	...
	static class DefaultID implements ID {
		...
		protected DefaultID(final byte[] _id) {
			super();
			primitive = null;
			id        = _id.clone();
		}
		protected DefaultID(final byte[] _id, Primitive _primitive) {
			super();
			primitive = _primitive;
			id        = _id.clone();
		}
		protected DefaultID(final short _id) {
			super();
		...
		protected DefaultID(final int _id) {
			super();
		...
		protected DefaultID(final long _id) {
			super();
		...
		protected DefaultID(final String _id) {
			super();
	...
	*/
	...
	private static final RandomString rndUtf8 = new RandomString(64, random);

	public static ID newBytes(byte[] _id) {
		return new DefaultID(_id);
	}
	...
	public static ID newUTF8(String _utf8) {
		return new DefaultID(_utf8);
	}
	public static ID newUTF8(String _utf8, boolean _hexValue) {
		if(_hexValue)
			return new DefaultID(Bytes.decodeHex(_utf8, StandardCharsets.UTF_8));
		return new DefaultID(_utf8);
	}
	...
	public static ID random(int _nbBytes) {
		...
		return new DefaultID(rand);
	}
	public static ID randomInt() {
		return new DefaultID(random.nextInt());
	}
	public static ID randomLong() {
		return new DefaultID(Math.abs(random.nextLong()));
	}
	public static ID randomUTF8() {
		return new DefaultID(rndUtf8.nextString());
	}
