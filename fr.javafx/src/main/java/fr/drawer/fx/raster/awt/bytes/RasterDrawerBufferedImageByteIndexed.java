...
public class RasterDrawerBufferedImageByteIndexed extends RasterDrawerBufferedImage {
	
	private final BufferedImage bimage;
	private final byte[] 		buffer;

	public RasterDrawerBufferedImageByteIndexed(XRasterBufferedImage _raster) {
		super(_raster);
