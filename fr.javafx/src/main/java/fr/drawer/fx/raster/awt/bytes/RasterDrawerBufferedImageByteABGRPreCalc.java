...
public class RasterDrawerBufferedImageByteABGRPreCalc extends RasterDrawerBufferedImage {
	
	private final BufferedImage bimage;
	private final byte[] 		buffer;

	public RasterDrawerBufferedImageByteABGRPreCalc(XRasterBufferedImage _raster) {
		super(_raster);
