...
public class RasterDrawerBufferedImageIntARGBPreCalc extends RasterDrawerBufferedImage {
	
	private final BufferedImage bimage;
	private final int[] 		buffer;

	public RasterDrawerBufferedImageIntARGBPreCalc(XRasterBufferedImage _raster) {
		super(_raster);
		...
		if(type != BufferedImage.TYPE_INT_ARGB_PRE || !(dbuffer instanceof DataBufferInt))
	...
	public byte getRed(int _i, int _j)   			{ return (byte) (buffer[(int) (_j * width + _i)] >>  8); }
	public byte getGreen(int _i, int _j) 			{ return (byte) (buffer[(int) (_j * width + _i)] >> 16); }
	public byte getBlue(int _i, int _j)  			{ return (byte) (buffer[(int) (_j * width + _i)] >> 24); }
/*
