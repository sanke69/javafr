...
public class RasterDrawerBufferedImageByteGray extends RasterDrawerBufferedImage {
	
	private final BufferedImage bimage;
	private final byte[] 		buffer;

	public RasterDrawerBufferedImageByteGray(XRasterBufferedImage _raster) {
		super(_raster);
		...
		if(type != BufferedImage.TYPE_BYTE_GRAY || !(dbuffer instanceof DataBufferByte))
