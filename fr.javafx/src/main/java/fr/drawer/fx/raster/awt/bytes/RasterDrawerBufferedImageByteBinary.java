...
public class RasterDrawerBufferedImageByteBinary extends RasterDrawerBufferedImage {
	
	private final BufferedImage bimage;
	private final byte[] 		buffer;

	public RasterDrawerBufferedImageByteBinary(XRasterBufferedImage _raster) {
		super(_raster);
		...
		if(type != BufferedImage.TYPE_BYTE_BINARY || !(dbuffer instanceof DataBufferByte))
	...
	public byte	getRed(int _i, int _j)   			{ return buffer[ (int) (depth * (_j * width + _i)) ]; }
	public byte	getGreen(int _i, int _j) 			{ return buffer[ (int) (depth * (_j * width + _i)) ]; }
	public byte	getBlue(int _i, int _j)  			{ return buffer[ (int) (depth * (_j * width + _i)) ]; }
/*
