package fr.javafx.sdk.controls.gauge.skins;

import java.util.ArrayList;
import java.util.List;

import fr.javafx.sdk.controls.gauge.GaugeBar;
...
public class GaugeBarModernSkin implements Skin<GaugeBar> {
	...
	private Node createGaugeBlend() {
		...
		float arcBlendDegrees = 130 + (1 - (float) this.gaugeBar.getValue() / this.gaugeBar.getMaxValue()) * 230;
