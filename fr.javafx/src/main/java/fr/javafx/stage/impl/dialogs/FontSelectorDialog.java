package fr.javafx.stage.impl.dialogs;
...
public class FontSelectorDialog extends Dialog<Font> {
    ...
    public FontSelectorDialog(Font defaultFont) {
        ...
        setTitle("font.dlg.title"/*localize(asKey("font.dlg.title"))*/); //$NON-NLS-1$
        dialogPane.setHeaderText("font.dlg.header"/*localize(asKey("font.dlg.header"))*/); //$NON-NLS-1$
 ...
 //       dialogPane.getStylesheets().add(FontSelectorDialog.class.getResource("dialogs.css").toExternalForm()); //$NON-NLS-1$
    ...
    private static class FontPanel extends GridPane {
        ...
        private final Text sample = new Text("font.dlg.sample.text"/*localize(asKey("font.dlg.sample.text"))*/); //$NON-NLS-1$
        ...
        public FontPanel() {
            ...
            // layout hello.dialog
            add(new Label("font.dlg.font.label"/*localize(asKey("font.dlg.font.label"))*/), 0, 0); //$NON-NLS-1$
            ...
            add( new Label("font.dlg.style.label"/*localize(asKey("font.dlg.style.label"))*/), 1, 0); //$NON-NLS-1$
            ...
            add( new Label("font.dlg.size.label"/*localize(asKey("font.dlg.size.label"))*/), 2, 0); //$NON-NLS-1$
