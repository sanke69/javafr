...
public class PasswordEditor extends PasswordField implements Editor<String> {
    ...
    @Override protected Skin<?> 		createDefaultSkin() {
        return new TextEditorSkin(this) {
            @Override public ObjectProperty<Node> leftProperty() {
                return PasswordEditor.this.leftProperty();
            }
            
            @Override public ObjectProperty<Node> rightProperty() {
                return PasswordEditor.this.rightProperty();
            }
        };
    }
