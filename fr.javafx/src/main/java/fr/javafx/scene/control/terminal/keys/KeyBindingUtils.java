package fr.javafx.scene.control.terminal.keys;
...
public class KeyBindingUtils {
	...
	public static void installEmacsKeyBinding(TextInputControl textInputControl) {
		textInputControl.addEventHandler(KeyEvent.KEY_PRESSED, e -> {
			if(e.isControlDown()) {
				switch (e.getCode()) {
				case F:		textInputControl.fireEvent(new KeyEvent(KeyEvent.KEY_PRESSED, "", "", KeyCode.RIGHT, false, false, false, false));
							e.consume();
							break;
				case B:
