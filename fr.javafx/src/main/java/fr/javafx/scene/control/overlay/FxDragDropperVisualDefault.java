...
@Deprecated
public class FxDragDropperVisualDefault extends StackPane implements Visual<FxDragDropper> {
	private final FxDragDropper control;
	...
	public FxDragDropperVisualDefault(FxDragDropper _control) {
		super();
		control = _control;
	...
	@Override
	public FxDragDropper getSkinnable() {
		return control;
	}
