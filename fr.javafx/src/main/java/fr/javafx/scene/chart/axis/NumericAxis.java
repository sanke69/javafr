...
public final class NumericAxis extends XYValueAxis {
    ...
    private static class NumericAxisRange implements XY.Axis.Range {
    	double lowerBound, upperBound, scale, tickSpacing; String tickFormat;

    	NumericAxisRange(double _lowerBound, double _upperBound, double _scale, String _tickFormat, double _tickSpacing) {
