...
//	record Entry(String name, int index, XY.Series.Style style) { };
	class Entry { 
		String name; int index; XY.Series.Style style;

		Entry(String _name, int _index, XY.Series.Style _style) {
			name  = _name;
			index = _index;
			style = _style;
		}
...
*/
    ...
    String symbolStyle (XY.Series.Style _style) {
		...
		if(_style.inColor() != null && _style.outColor() != null)
			sb.append(String.format("-fx-background-color: %s, %s; ", _style.inColorHex4(), _style.outColorHex4()));
    ...
    String lineStyle   (XY.Series.Style _style) {
        ...
        if(_style.inColor() != null)
			sb.append(String.format("-fx-stroke: %s; ", _style.inColorHex4()));
