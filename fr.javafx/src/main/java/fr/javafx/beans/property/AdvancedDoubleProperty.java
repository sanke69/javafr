...
public class AdvancedDoubleProperty implements Property<Number>, NumberExpression, WritableDoubleValue {
	private ObjectProperty<Double> value;

    public AdvancedDoubleProperty() {
        this(null, "");
    }
    public AdvancedDoubleProperty(Double initialValue) {
        this(null, "", initialValue);
    }
    public AdvancedDoubleProperty(Object bean, String name) {
        super();
        value  = new SimpleObjectProperty<Double>(bean, name, 0D);
    }
    public AdvancedDoubleProperty(Object bean, String name, Double initialValue) {
        super();
        value  = new SimpleObjectProperty<Double>(bean, name, initialValue);
    }
	...
	public void 			setValue(Number _value) {
		if(_value != null)
			value.setValue(_value.doubleValue());
		else
			value.setValue(null);
	}
	...
	protected ObjectProperty<Double> objectProperty() {
		return value;
	}
	...
	public void 			bind(ObservableValue<? extends Number> newObservable) {
		ObjectBinding<Double> binder = Bindings.createObjectBinding(
				() ->  newObservable.getValue().doubleValue(), newObservable
		);
		value.bind(binder);
		
//		DoubleProperty integerProperty = DoubleProperty.integerProperty(newObservable);
//		Bindings.bindBidirectional(value, newObservable);
//		value.bind(newObservable);
	}
	public void 			bind(DoubleProperty newObservable) {
		DoubleProperty integerProperty = DoubleProperty.doubleProperty(value);
