...
@Deprecated
public class FxBeanPropertyBindings extends BeanProperties {
    ...
    public static <T> void 		bind(ReadOnlyBeanProperty<T> propertyA, Property<T> propertyB) {
    ...
    public static <T> void 		bind(Property<T> propertyA, BeanProperty<T> propertyB) {
        addFlaggedChangeListenerToBP(propertyA, propertyB, t -> t);
    }
    ...
    public static <T> void 		bindBidirectional(BeanProperty<T> propertyA, Property<T> propertyB) {
    	addFlaggedChangeListenerToFx(propertyA, propertyB, t -> t);
    	addFlaggedChangeListenerToBP(propertyB, propertyA, t -> t);
    }
    ...
    public static <T> void 		bindBidirectional(Property<T> propertyA, BeanProperty<T> propertyB) {
    	addFlaggedChangeListenerToBP(propertyA, propertyB, t -> t);
...
/*
    public static void 			bind(DoubleBeanProperty propertyA, DoubleProperty propertyB) {
    	addFlaggedChangeListenerToFx(propertyA, propertyB, t -> t);
    }
    public static void 			bind(DoubleBeanProperty propertyA, DoubleProperty propertyB, Function<Double, Number> updateB) {
    	addFlaggedChangeListenerToFx(propertyA, propertyB, updateB);
    }
    public static <A ,B> void 	unbind(DoubleBeanProperty propertyA, DoubleProperty propertyB) {
    	bindings2FX.remove(Pair.of(propertyA, propertyB));
    }

    public static void 			bindBidirectional(DoubleBeanProperty propertyA, DoubleProperty propertyB) {
    	addFlaggedChangeListenerToFx(propertyA, propertyB, t -> t);
    	addFlaggedChangeListenerToBP(propertyB, propertyA, t -> t.doubleValue());
    }
    public static void 			bindBidirectional(DoubleBeanProperty propertyA, DoubleProperty propertyB, Function<A,B> updateB, Function<B,A> updateA) {
    	addFlaggedChangeListenerToFx(propertyA, propertyB, updateB);
    	addFlaggedChangeListenerToBP(propertyB, propertyA, updateA);
    }
    
    public static void 			bindBidirectional(DoubleProperty propertyA, DoubleBeanProperty propertyB) {
    	addFlaggedChangeListenerToBP(propertyA, propertyB, t -> t.doubleValue());
    	addFlaggedChangeListenerToFx(propertyB, propertyA, t -> t);
    }
    public static void 			bindBidirectional(DoubleProperty propertyA, DoubleBeanProperty propertyB, Function<A,B> updateB, Function<B,A> updateA) {
    	addFlaggedChangeListenerToBP(propertyA, propertyB, updateB);
    	addFlaggedChangeListenerToFx(propertyB, propertyA, updateA);
    }
*/
