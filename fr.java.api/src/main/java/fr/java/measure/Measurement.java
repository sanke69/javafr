...
public interface Measurement extends Measure, Nameable {

	public static Measurement of(String _name, Measure.Type _type, double _value, Unit _unit) {
	...
	public static Measurement of(String _name, Measure.Type _type, double _value, Unit _unit, Modifier _modifier) {
		return new Measurement() {
