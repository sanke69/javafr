...
public interface Windowable {
	...
	/**
	 * Defines whether this control shall be minimized.
	 *
	 * @param v the state to set
	 */
	public void 		setMinimized(boolean v);
	/**
	 * Indicates whether the control is currently minimized.
	 *
	 * @return <code>true</code> if the control is currently minimized;
