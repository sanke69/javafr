...
public interface Video<T> extends Media<VideoFrame<T>> {

	public interface Awt	extends Video<BufferedImage> { }
	public interface Fx 	extends Video<Image> { }

	public default boolean 	isPlayable() 	{ return true; }
