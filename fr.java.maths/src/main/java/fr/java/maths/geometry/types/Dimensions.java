...
public class Dimensions {
	...
	public static Dimension2D 			of(final double _width, final double _height) {
		return new SimpleDimension2D(_width, _height);
	}
	public static Dimension2D.Editable 	ofEditable(final double _width, final double _height) {
		return new SimpleDimension2D(_width, _height);
	}
	...
	public static Dimension2D 					unit2() {
		return new SimpleDimension2D(1, 1);
	}
	public static Dimension3D 					unit3() {
