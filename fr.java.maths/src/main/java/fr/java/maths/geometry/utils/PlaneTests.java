package fr.java.maths.geometry.utils;
...
import fr.java.maths.geometry.plane.types.SimpleRay2D;


public class PlaneTests {

	public static void main(String[] args) {
		Segment2D   s = Segments.of(-2, 8, 11, 11);
		Rectangle2D r = Rectangles.of(0, 0, 10, 10);
		Rectangle2D r2 = Rectangles.of(5, 5, 9, 9);
	...
	public static Point2D getIntersection(Segment2D _s, Rectangle2D _r) {
	    ...
	    if (_s.getEnd().getX() < _r.getLeft()) {
	        ...
	        if (_s.getEnd().getY() > _r.getBottom() && _s.getEnd().getY() < _r.getTop()) {
	        	...
	        	return getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getLeft(), _r.getTop())));

	        } else if (_s.getEnd().getY() < _r.getBottom()) {
	        	// //If it is at the bottom-left
	            intersection = getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getRight(), _r.getBottom())));
	            if (intersection == null) 
	            	intersection = getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getLeft(), _r.getTop())));
	            return intersection;

	        } else {
	        	//if p2.y > max_y, i.e. if it is at the top-left	
	            intersection = getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getTop()), Points.of(_r.getRight(), _r.getTop())));
	            if (intersection == null) 
	            	intersection = getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getLeft(), _r.getTop())));
	            return intersection;
	        ...
	        if (_s.getEnd().getY() > _r.getBottom() && _s.getEnd().getY() < _r.getTop()) {
	        	...
	        	return getIntersection(_s, Segments.of(Points.of(_r.getRight(), _r.getBottom()), Points.of(_r.getRight(), _r.getTop())));

	        } else if (_s.getEnd().getY() < _r.getBottom()) {
	        	//If it is at the bottom-right
	            intersection = getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getRight(), _r.getBottom())));
	            if (intersection == null) 
	            	intersection = getIntersection(_s, Segments.of(Points.of(_r.getRight(), _r.getBottom()), Points.of(_r.getRight(), _r.getTop())));
	            return intersection;
	        }
	        else {
	        	//if p2.y > max_y, i.e. if it is at the top-left
	        ...
	        if (_s.getEnd().getY() < _r.getBottom()) 
	        	...
	        	return getIntersection(_s, Segments.of(Points.of(_r.getLeft(), _r.getBottom()), Points.of(_r.getRight(), _r.getBottom())));
	        if (_s.getEnd().getY() > _r.getTop()) 
	        	//If it is at the top
	        	return getIntersection(_s, Segments.of(Points.of(_r.getRight(), _r.getTop()), Points.of(_r.getRight(), _r.getTop()))); 
	    }
