...
public class SimpleVector4D extends AdapterVectorDouble.Editable implements DoubleVector.Editable, Vector4D.Editable {
	...
	public SimpleVector4D() {
	    this(0, 0, 0, 0);
	}
	public SimpleVector4D(final double _x, final double _y, final double _z, final double _w) {
		super(4);
		x = _x;
		y = _y;
		z = _z;
	...
	public SimpleVector4D(final SimpleVector3D _d, final double _w) {
		this(_d.getX(), _d.getY(), _d.getZ(), _w);
	}
	public SimpleVector4D(final SimpleVector4D _d) {
	...
	@Override
	public final SimpleVector4D 	plus(final double _t) {
		return new SimpleVector4D(x+_t, y+_t, z+_t, w+_t);
	}
	@Override
	public final SimpleVector4D 	plus(final double _t, final double _u, final double _v, final double _w) {
		return new SimpleVector4D(x+_t, y+_u, z+_v, w+_w);
	}
	@Override
	public final SimpleVector4D 	plus(final double[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x+_v[0], y+_v[1], z+_v[2], w+_v[3]);
	}
	@Override
	public final SimpleVector4D 	plus(final Number _t) {
		return new SimpleVector4D(x+_t.doubleValue(), y+_t.doubleValue(), z+_t.doubleValue(), w+_t.doubleValue());
	}
	@Override
	public final SimpleVector4D 	plus(final Number _x, final Number _y, final Number _z, final Number _w) {
		return new SimpleVector4D(x+_x.doubleValue(), y+_y.doubleValue(), z+_z.doubleValue(), w+_w.doubleValue());
	}
	@Override
	public final SimpleVector4D 	plus(final Number[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x+_v[0].doubleValue(), y+_v[1].doubleValue(), z+_v[2].doubleValue(), w+_v[3].doubleValue());
	}
	@Override
	public final SimpleVector4D 	plus(final Vector4D _d) {
		return new SimpleVector4D(x+_d.getX(), y+_d.getY(), z+_d.getZ(), w+_d.getW());
	}

	@Override
	public final SimpleVector4D 	plusEquals(final double _t) {
		x += _t;
		y += _t;
		z += _t;
		return this;
	...
	@Override
	public final SimpleVector4D 	plusEquals(final double _t, final double _u, final double _v, final double _w) {
		x += _t;
		y += _u;
		z += _v;
		w += _w;
	...
	@Override
	public final SimpleVector4D 	plusEquals(final double[] _v) {
		assert(_v.length >= 4);
		x += _v[0];
		y += _v[1];
		z += _v[2];
	...
	@Override
	public final SimpleVector4D 	plusEquals(final Number _t) {
		x += _t.doubleValue();
		y += _t.doubleValue();
		z += _t.doubleValue();
		return this;
	...
	@Override
	public final SimpleVector4D 	plusEquals(final Number _x, final Number _y, final Number _z, final Number _w) {
		x += _x.doubleValue();
		y += _y.doubleValue();
		z += _z.doubleValue();
		z += _w.doubleValue();
	...
	@Override
	public final SimpleVector4D 	plusEquals(final Number[] _v) {
		assert(_v.length >= 4);
		x += _v[0].doubleValue();
		y += _v[1].doubleValue();
		z += _v[2].doubleValue();
	...
	@Override
	public final SimpleVector4D 	plusEquals(final Vector4D _d) {
		x += _d.getX();
		y += _d.getY();
		z += _d.getZ();
		w += _d.getW();
	...
	@Override
	public final SimpleVector4D 	minus(final double _t) {
		return new SimpleVector4D(x-_t, y-_t, z-_t, w-_t);
	}
	@Override
	public final SimpleVector4D 	minus(final double _t, final double _u, final double _v, final double _w) {
		return new SimpleVector4D(x-_t, y-_u, z-_v, w-_w);
	}
	@Override
	public final SimpleVector4D 	minus(final double[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x-_v[0], y-_v[1], z-_v[2], w-_v[3]);
	}
	@Override
	public final SimpleVector4D 	minus(final Number _t) {
		return new SimpleVector4D(x-_t.doubleValue(), y-_t.doubleValue(), z-_t.doubleValue(), w-_t.doubleValue());
	}
	@Override
	public final SimpleVector4D 	minus(final Number _x, final Number _y, final Number _z, final Number _w) {
		return new SimpleVector4D(x-_x.doubleValue(), y-_y.doubleValue(), z-_z.doubleValue(), w-_w.doubleValue());
	}
	@Override
	public final SimpleVector4D 	minus(final Number[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x-_v[0].doubleValue(), y-_v[1].doubleValue(), z-_v[2].doubleValue(), w-_v[3].doubleValue());
	}
	@Override
	public final SimpleVector4D 	minus(final Vector4D _d) {
		return new SimpleVector4D(x-_d.getX(), y-_d.getY(), z-_d.getZ(), w-_d.getW());
	}

	@Override
	public final SimpleVector4D 	minusEquals(final double _t) {
		x -= _t;
		y -= _t;
		z -= _t;
		w -= _t;
	...
	@Override
	public final SimpleVector4D 	minusEquals(final double _t, final double _u, final double _v, final double _w) {
		x -= _t;
		y -= _u;
		z -= _v;
		w -= _w;
	...
	@Override
	public final SimpleVector4D 	minusEquals(final double[] _v) {
		assert(_v.length >= 4);
		x -= _v[0];
		y -= _v[1];
		z -= _v[2];
	...
	@Override
	public final SimpleVector4D 	minusEquals(final Number _t) {
		x -= _t.doubleValue();
		y -= _t.doubleValue();
		z -= _t.doubleValue();
		w -= _t.doubleValue();
	...
	@Override
	public final SimpleVector4D 	minusEquals(final Number _x, final Number _y, final Number _z, final Number _w) {
		x -= _x.doubleValue();
		y -= _y.doubleValue();
		z -= _z.doubleValue();
		w -= _w.doubleValue();
	...
	@Override
	public final SimpleVector4D 	minusEquals(final Number[] _v) {
		assert(_v.length >= 4);
		x -= _v[0].doubleValue();
		y -= _v[1].doubleValue();
		z -= _v[2].doubleValue();
	...
	@Override
	public final SimpleVector4D 	minusEquals(final Vector4D _v) {
		assert(_v.size() >= 4);
		x -= _v.getX();
		y -= _v.getY();
		z -= _v.getZ();
	...
	@Override
	public final SimpleVector4D 	times(final double _t) {
		return new SimpleVector4D(x*_t, y*_t, z*_t, w*_t);
	}
	@Override
	public final SimpleVector4D 	times(final double _t, final double _u, final double _v, final double _w) {
		return new SimpleVector4D(x*_t, y*_u, z*_v, w*_w);
	}
	@Override
	public final SimpleVector4D 	times(final double[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x*_v[0], y*_v[1], z*_v[2], w*_v[3]);
	}
	@Override
	public final SimpleVector4D 	times(final Number _t) {
		return new SimpleVector4D(x*_t.doubleValue(), y*_t.doubleValue(), z*_t.doubleValue(), w*_t.doubleValue());
	}
	@Override
	public final SimpleVector4D 	times(final Number _x, final Number _y, final Number _z, final Number _w) {
		return new SimpleVector4D(x*_x.doubleValue(), y*_y.doubleValue(), z*_z.doubleValue(), w*_w.doubleValue());
	}
	@Override
	public final SimpleVector4D 	times(final Number[] _v) {
		assert(_v.length >= 4);
		return new SimpleVector4D(x*_v[0].doubleValue(), y*_v[1].doubleValue(), z*_v[2].doubleValue(), w*_v[3].doubleValue());
	}
	@Override
	public final SimpleVector4D 	times(final Vector4D _d) {
		return new SimpleVector4D(x*_d.getX(), y*_d.getY(), z*_d.getZ(), w*_d.getW());
	}

	@Override
	public final SimpleVector4D 	timesEquals(final double _t) {
		x *= _t;
		y *= _t;
		z *= _t;
		w *= _t;
	...
	@Override
	public final SimpleVector4D 	timesEquals(final double _t, final double _u, final double _v, final double _w) {
		x *= _t;
		y *= _u;
		z *= _v;
		w *= _w;
	...
	@Override
	public final SimpleVector4D 	timesEquals(final double[] _v) {
		assert(_v.length >= 4);
		x *= _v[0];
		y *= _v[1];
		z *= _v[2];
	...
	@Override
	public final SimpleVector4D 	timesEquals(final Number _t) {
		x *= _t.doubleValue();
		y *= _t.doubleValue();
		z *= _t.doubleValue();
		w *= _t.doubleValue();
	...
	@Override
	public final SimpleVector4D 	timesEquals(final Number _x, final Number _y, final Number _z, final Number _w) {
		x *= _x.doubleValue();
		y *= _y.doubleValue();
		z *= _z.doubleValue();
		w *= _w.doubleValue();
	...
	@Override
	public final SimpleVector4D 	timesEquals(final Number[] _v) {
		assert(_v.length >= 4);
		x *= _v[0].doubleValue();
		y *= _v[1].doubleValue();
		z *= _v[2].doubleValue();
	...
	@Override
	public final SimpleVector4D 	timesEquals(final Vector4D _d) {
		x *= _d.getX();
		y *= _d.getY();
		z *= _d.getZ();
		w *= _d.getW();
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final double _t, final double _u, final double _v, final double _w) {
		if(_t == 0 || _u == 0 || _v == 0 || _w == 0) throw new RuntimeException("Divide by 0");
		x /= _t;
		y /= _u;
		z /= _v;
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final double[] _v) {
		assert(_v.length >= 4);
		if(_v[0] == 0 || _v[1] == 0 || _v[2] == 0 || _v[3] == 0) throw new RuntimeException("Divide by 0");
		x /= _v[0];
		y /= _v[1];
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final Number _t) {
		if(_t.doubleValue() == 0) throw new RuntimeException("Divide by 0");
		x /= _t.doubleValue();
		y /= _t.doubleValue();
		z /= _t.doubleValue();
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final Number _x, final Number _y, final Number _z, final Number _w) {
		if(_x.doubleValue() == 0 || _y.doubleValue() == 0 || _z.doubleValue() == 0 || _w.doubleValue() == 0) throw new RuntimeException("Divide by 0");
		x /= _x.doubleValue();
		y /= _y.doubleValue();
		z /= _z.doubleValue();
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final Number[] _v) {
		assert(_v.length >= 4);
		if(_v[0].doubleValue() == 0 || _v[1].doubleValue() == 0 || _v[2].doubleValue() == 0 || _v[3].doubleValue() == 0) throw new RuntimeException("Divide by 0");
		x /= _v[0].doubleValue();
		y /= _v[1].doubleValue();
	...
	@Override
	public final SimpleVector4D 	dividesEquals(final Vector4D _d) {
		if(_d.getX() == 0 || _d.getY() == 0 || _d.getZ() == 0 || _d.getW() == 0) throw new RuntimeException("Divide by 0");
		x /= _d.getX();
		y /= _d.getY();
		z /= _d.getZ();
	...
	public Vector3D downgrade() {
		return new SimpleVector3D(getW() * getX(), getW() * getY(), getW() * getZ());
	}
	...
	@Override
	public final SimpleVector4D 		clone() {
		return new SimpleVector4D(x, y, z, w);
	}
	@Override
	public final SimpleVector4D cloneEditable() {
		return new SimpleVector4D(x, y, z, w);
	}

	@Override
	public final SimpleVector4D 		abs() {
		return new SimpleVector4D(Math.abs(x), Math.abs(y), Math.abs(z), Math.abs(w));
	}
	@Override
	public final SimpleVector4D 		negate() {
		return new SimpleVector4D(-x, -y, -z, -w);
	}
	@Override
	public final SimpleVector4D 		normalized() {
		double length = norm();
		if(length < Point.EPSILON)
			return this;
		double invLength = 1.0f / length;
		return new SimpleVector4D(x * invLength, y * invLength, z * invLength, w * invLength);
	}
	...
	public final static SimpleVector4D crossProduct(final SimpleVector4D _a, final SimpleVector4D _b) {
		return new SimpleVector4D(  _a.y*_b.x - _a.x*_b.y, 
	...
	public boolean equals(Object obj) {
		...
		if(getClass() != obj.getClass())
			return false;
		SimpleVector4D other = (SimpleVector4D) obj;
