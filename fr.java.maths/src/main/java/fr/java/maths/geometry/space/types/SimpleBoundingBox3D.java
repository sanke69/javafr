...
public class SimpleBoundingBox3D implements BoundingBox3D.Editable {
	private static final long serialVersionUID = -4298538292966277165L;

	public static SimpleBoundingBox3D empty() {
		return new SimpleBoundingBox3D(0, 0, 0, 0, 0, 0);
	}
	public static SimpleBoundingBox3D unit() {
		return new SimpleBoundingBox3D(0, 0, 0, 1, 1, 1);
	}

	public static SimpleBoundingBox3D of(double _x, double _y, double _z, double _w, double _h, double _d) {
		return new SimpleBoundingBox3D(_x, _y, _z, _w, _h, _d);
	}
	
	protected double	minX, minY, minZ;
	protected double	width, height, depth;

	public SimpleBoundingBox3D() {
		super();
		minX = minY = minZ = 0.0;
		width = height = depth = 1.0;
	}
	public SimpleBoundingBox3D(double _width, double _height, double _depth) {
		this();
		width = _width;
		height = _height;
		depth = _depth;
	}
	public SimpleBoundingBox3D(Dimension3D _dimensions) {
		this(_dimensions.getWidth(), _dimensions.getHeight(), _dimensions.getDepth());
	}
	public SimpleBoundingBox3D(double _x, double _y, double _z, double _width, double _height, double _depth) {
		super();
		minX = _x;
		minY = _y;
		minZ = _z;
	...
	public SimpleBoundingBox3D(Point3D _position, Dimension3D _dimensions) {
		this(_position.getX(), _position.getY(), _position.getZ(), _dimensions.getWidth(), _dimensions.getHeight(), _dimensions.getDepth());
	}
	public SimpleBoundingBox3D(BoundingBox3D _clone) {
		this();
		minX = _clone.getLeft();
	...
	public SimpleBoundingBox3D(Set<Point3D> _points) {
	...
	public SimpleBoundingBox3D(Point3DBufferX _points) {
...
//	@Override
	...
	*/
	...
	@Override
	public SimpleBoundingBox3D clone() {
		return new SimpleBoundingBox3D(minX, minY, minZ, width, height, depth);
	}
	...
	public boolean equals(Object obj) {
		if(obj == this)
			return true;
		if(obj instanceof SimpleBoundingBox3D) {
			SimpleBoundingBox3D other = (SimpleBoundingBox3D) obj;
