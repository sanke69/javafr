 ...
 *                                                                            *
\** ************************************************************************ **/
package fr.java.maths.geometry.space.shapes.quadrics.shapes;
...
public class QuadricEllipsoid3D extends Quadric3DBase implements QuadricShape3D, Ellipsoid3D {
	...
	public static QuadricEllipsoid3D createFrom(Point3D _center, Dimension3D _dimensions) {
		...
		QuadricEllipsoid3D result = new QuadricEllipsoid3D(A, B, C, G, H, I, J);
	...
	QuadricEllipsoid3D(double _x2, double _y2, double _z2, double _x, double _y, double _z, double _cst) {
		super(_x2, _y2, _z2, 0, 0, 0, _x, _y, _z, _cst);
	}
	public  QuadricEllipsoid3D() {
