...
import fr.java.math.algebra.matrix.generic.Matrix22D;
...
public class DoubleMatrix22 implements Matrix22D.Editable {
	private static final long serialVersionUID = 1L;

	public final static DoubleMatrix22 zero() {
		return new DoubleMatrix22(0,0,0,0);
	}
	public final static DoubleMatrix22 identity() {
		return new DoubleMatrix22(1,0,0,1);
	}
	public final static DoubleMatrix22 unitary() {
		return new DoubleMatrix22(1,1,1,1);
	}
	...
	public DoubleMatrix22(final double _m00, final double _m01, final double _m10, final double _m11) {
		m00 = _m00; m01 = _m01; m10 = _m10; m11 = _m11;
	}
	public DoubleMatrix22(final DoubleMatrix22 _d) {
	...
	public final DoubleMatrix22 		plus(final Number _t) {
		return new DoubleMatrix22(m00 + _t.doubleValue(), m01 + _t.doubleValue(), m10 + _t.doubleValue(), m11 + _t.doubleValue());
	}
	public final DoubleMatrix22 		plus(final NumberMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(m00 + _m.getNumber(0,0).doubleValue(), m01 + _m.getNumber(0,1).doubleValue(), m10 + _m.getNumber(1,0).doubleValue(), m11 + _m.getNumber(1,1).doubleValue());
	}

	public final DoubleMatrix22 		plus(final double _t) {
		return new DoubleMatrix22(m00 + _t, m01 + _t, m10 + _t, m11 + _t);
	}
	public final DoubleMatrix22 		plus(final DoubleMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(m00 + _m.get(0,0), m01 + _m.get(0,1), m10 + _m.get(1,0), m11 + _m.get(1,1));
	}

	public final DoubleMatrix22 		plus(final Matrix22D _m) {
		return new DoubleMatrix22(m00 + _m.get(0,0), m01 + _m.get(0,1), m10 + _m.get(1,0), m11 + _m.get(1,1));
	}

	public final DoubleMatrix22 		plusEquals(final Number _t) {
		m00 += _t.doubleValue(); m01 += _t.doubleValue(); m10 += _t.doubleValue(); m11 += _t.doubleValue();
		return this;
	}
	public final DoubleMatrix22 		plusEquals(final NumberMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
	...
	public final DoubleMatrix22 		plusEquals(final double _t) {
		m00 += _t; m01 += _t; m10 += _t; m11 += _t;
		return this;
	}
	public final DoubleMatrix22 		plusEquals(final DoubleMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		m00 += _m.get(0,0); m01 += _m.get(0,1); m10 += _m.get(1,0); m11 += _m.get(1,1);
		return this;
	}
	
	public final DoubleMatrix22 		plusEquals(final Matrix22D _m) {
		m00 += _m.get(0,0); m01 += _m.get(0,1); m10 += _m.get(1,0); m11 += _m.get(1,1);
		return this;
	}

	public final DoubleMatrix22 		minus(final Number _t) {
		return new DoubleMatrix22(m00 - _t.doubleValue(), m01 - _t.doubleValue(), m10 - _t.doubleValue(), m11 - _t.doubleValue());
	}
	public final DoubleMatrix22 		minus(final NumberMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(m00 - _m.getNumber(0,0).doubleValue(), m01 - _m.getNumber(0,1).doubleValue(), m10 - _m.getNumber(1,0).doubleValue(), m11 - _m.getNumber(1,1).doubleValue());
	}

	public final DoubleMatrix22 		minus(final double _t) {
		return new DoubleMatrix22(m00 - _t, m01 - _t, m10 - _t, m11 - _t);
	}
	public final DoubleMatrix22 		minus(final DoubleMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(m00 - _m.get(0,0), m01 - _m.get(0,1), m10 - _m.get(1,0), m11 - _m.get(1,1));
	}
	
	public final DoubleMatrix22 		minus(final Matrix22D _m) {
		return new DoubleMatrix22(m00 - _m.get(0,0), m01 - _m.get(0,1), m10 - _m.get(1,0), m11 - _m.get(1,1));
	}

	public final DoubleMatrix22 		minusEquals(final Number _t) {
		m00 -= _t.doubleValue(); m01 -= _t.doubleValue(); m10 -= _t.doubleValue(); m11 -= _t.doubleValue();
		return this;
	}
	public final DoubleMatrix22 		minusEquals(final NumberMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		m00 -= _m.getNumber(0,0).doubleValue(); m01 -= _m.getNumber(0,1).doubleValue(); m10 -= _m.getNumber(1,0).doubleValue(); m11 -= _m.getNumber(1,1).doubleValue();
		return this;
	}
	
	public final DoubleMatrix22 		minusEquals(final double _t) {
		m00 -= _t; m01 -= _t; m10 -= _t; m11 -= _t;
		return this;
	}
	public final DoubleMatrix22 		minusEquals(final DoubleMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		m00 -= _m.get(0,0); m01 -= _m.get(0,1); m10 -= _m.get(1,0); m11 -= _m.get(1,1);
		return this;
	}

	public final DoubleMatrix22 		minusEquals(final Matrix22D _m) {
		m00 -= _m.get(0,0); m01 -= _m.get(0,1); m10 -= _m.get(1,0); m11 -= _m.get(1,1);
		return this;
	}

	public final DoubleMatrix22 		times(final Number _t) {
		return new DoubleMatrix22(m00 * _t.doubleValue(), m01 * _t.doubleValue(), m10 * _t.doubleValue(), m11 * _t.doubleValue());
	}
	...
	public final DoubleMatrix22 		times(final NumberMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(	m00*_m.getNumber(0,0).doubleValue() + m01*_m.getNumber(1,0).doubleValue(),
	...
	public final DoubleMatrix22 		times(final double _t) {
		return new DoubleMatrix22(m00 * _t, m01 * _t, m10 * _t, m11 * _t);
	}
	...
	public final DoubleMatrix22 		times(final DoubleMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(	m00*_m.get(0,0) + m01*_m.get(1,0),
								m00*_m.get(0,1) + m01*_m.get(1,1),
								m10*_m.get(0,0) + m11*_m.get(1,0),
								m10*_m.get(0,1) + m11*_m.get(1,1)
							 );
	}
	public final DoubleMatrix22 		times(final SquareMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		return new DoubleMatrix22(	m00*_m.getNumber(0,0).doubleValue() + m01*_m.getNumber(1,0).doubleValue(),
								m00*_m.getNumber(0,1).doubleValue() + m01*_m.getNumber(1,1).doubleValue(),
								m10*_m.getNumber(0,0).doubleValue() + m11*_m.getNumber(1,0).doubleValue(),
	...
	public final DoubleMatrix22 		times(final Matrix22D _m) {
		return new DoubleMatrix22(	m00*_m.get(0,0) + get(0,1)*_m.get(1,0),
	...
	public final DoubleMatrix22 		timesEquals(final Number _t) {
		m00 *= _t.doubleValue(); m01 *= _t.doubleValue(); m10 *= _t.doubleValue(); m11 *= _t.doubleValue();
		return this;
	}
	public final DoubleMatrix22 		timesEquals(final double _t) {
		m00 *= _t; m01 *= _t; m10 *= _t; m11 *= _t;
		return this;
	}
	@Override
	public final DoubleMatrix22 		timesEquals(NumberMatrix _m) {
	...
	@Override
	public final DoubleMatrix22 		timesEquals(DoubleMatrix _m) {
		m00*=_m.get(0,0); m01*=_m.get(0,1);
		m10*=_m.get(0,0); m11*=_m.get(0,1);
		return this;
	}
	public final DoubleMatrix22 		timesEquals(final SquareMatrix _m) {
		assert(_m.rows() == 2 && _m.columns() == 2);
		set(
	...
	public final DoubleMatrix22 		timesEquals(final Matrix22D _d) {
		set(
	...
	@Override
	public final DoubleMatrix22 		arrayTimes(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(m00*B.getNumber(0, 0).doubleValue(), m01*B.getNumber(0, 1).doubleValue(),
							m10*B.getNumber(1, 0).doubleValue(), m11*B.getNumber(1, 1).doubleValue()
						 );
	}
	@Override
	public final DoubleMatrix22 		arrayTimes(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(m00*B.get(0, 0), m01*B.get(0, 1),
							m10*B.get(1, 0), m11*B.get(1, 1)
						 );
	}

	public final DoubleMatrix22 		arrayTimes(final Matrix22D B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(m00*B.get(0,0), m01*B.get(0,1),
							m10*B.get(1,0), m11*B.get(1,1)
						 );
	...
	@Override
	public final DoubleMatrix22 		arrayTimesEquals(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
	...
	@Override
	public final DoubleMatrix22 		arrayTimesEquals(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		m00 *= B.get(0, 0);
		m01 *= B.get(0, 1);
		m10 *= B.get(1, 0);
	...
	@Override
	public final DoubleMatrix22 		arrayRightDivide(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(m00/B.getNumber(0, 0).doubleValue(), m01/B.getNumber(0, 1).doubleValue(),
							m10/B.getNumber(1, 0).doubleValue(), m11/B.getNumber(1, 1).doubleValue()
						 );
	...
	@Override
	public final DoubleMatrix22 		arrayRightDivide(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(m00/B.get(0, 0), m01/B.get(0, 1),
							m10/B.get(1, 0), m11/B.get(1, 1)
						 );
	...
	@Override
	public final DoubleMatrix22 		arrayRightDivideEquals(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		m00 /= B.getNumber(0, 0).doubleValue();
		m01 /= B.getNumber(0, 1).doubleValue();
		m10 /= B.getNumber(1, 0).doubleValue();
	...
	@Override
	public final DoubleMatrix22 		arrayRightDivideEquals(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		m00 /= B.get(0, 0);
		m01 /= B.get(0, 1);
		m10 /= B.get(1, 0);
	...
	@Override
	public final DoubleMatrix22 		arrayLeftDivide(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(B.getNumber(0, 0).doubleValue()/m00, B.getNumber(0, 1).doubleValue()/m01,
							 B.getNumber(1, 0).doubleValue()/m10, B.getNumber(1, 1).doubleValue()/m11
						 	);
	}
	@Override
	public final DoubleMatrix22 		arrayLeftDivide(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		return new DoubleMatrix22(B.get(0, 0)/m00, B.get(0, 1)/m01,
							 B.get(1, 0)/m10, B.get(1, 1)/m11
						 	);
	}

	@Override
	public final DoubleMatrix22 		arrayLeftDivideEquals(final NumberMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
	...
	@Override
	public final DoubleMatrix22 		arrayLeftDivideEquals(final DoubleMatrix B) {
		assert(B.rows() == 2 && B.columns() == 2);
		m00 = B.get(0, 0) / m00;
		m01 = B.get(0, 1) / m01;
		m10 = B.get(1, 0) / m10;
	...
	@Override
	public final DoubleMatrix22 		clone() {
		return new DoubleMatrix22(m00, m01, m10, m11);
	}
	@Override
	public final DoubleMatrix22 		abs() {
		return new DoubleMatrix22(Math.abs(m00), Math.abs(m01), Math.abs(m10), Math.abs(m11));
	}
	@Override
	public final DoubleMatrix22 		transpose() {
		return new DoubleMatrix22(m00, m10, m01, m11);
	}
	@Override
	public final DoubleMatrix22 		inverse() {
		double det = det();
		if(det == 0)
			return null;
		...
		final DoubleMatrix22 B = new DoubleMatrix22();
		B.m00 =  det * m11;
		B.m01 = -det * m01;
		B.m10 = -det * m10;
		B.m11 =  det * m00;
	...
	@Override
	public final DoubleMatrix22 		uminus() {
		return new DoubleMatrix22(-m00, -m01, -m10, -m11);
	}
	...
	public boolean equals(Object _obj) {
		...
		if(getClass() != _obj.getClass())
			return false;
		DoubleMatrix22 other = (DoubleMatrix22) _obj;
