...
public class DoubleMatrix33 implements Matrix33D.Editable {
	private static final long serialVersionUID = 1L;

	public final static DoubleMatrix33 zero() {
		return new DoubleMatrix33(0,0,0,0,0,0,0,0,0);
	}
	public final static DoubleMatrix33 identity() {
		return new DoubleMatrix33(1,0,0,0,1,0,0,0,1);
	}
	public final static DoubleMatrix33 unitary() {
	...
	public DoubleMatrix33() {
	}
	public DoubleMatrix33(final double _m00, final double _m01, final double _m02, final double _m10, final double _m11, final double _m12, final double _m20, final double _m21, final double _m22) {
		m00 = _m00; m01 = _m01; m02 = _m02;
		m10 = _m10; m11 = _m11; m12 = _m12;
		m20 = _m20; m21 = _m21; m22 = _m22;
	}
	public DoubleMatrix33(final DoubleMatrix33 _d) {
	...
	@Override
	public final DoubleMatrix33 		plus(final Number _t) {
		return new DoubleMatrix33(m00 + _t.doubleValue(), m01 + _t.doubleValue(), m02 + _t.doubleValue(),
							 m10 + _t.doubleValue(), m11 + _t.doubleValue(), m12 + _t.doubleValue(),
							 m20 + _t.doubleValue(), m21 + _t.doubleValue(), m22 + _t.doubleValue());
	}
	@Override
	public final DoubleMatrix33 		plus(final NumberMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		return new DoubleMatrix33(m00 + _m.getNumber(0,0).doubleValue(), m01 + _m.getNumber(0,1).doubleValue(), m02 + _m.getNumber(0,2).doubleValue(),
	...
	@Override
	public final DoubleMatrix33 		plus(final double _t) {
		return new DoubleMatrix33(m00 + _t, m01 + _t, m02 + _t,
							 m10 + _t, m11 + _t, m12 + _t,
							 m20 + _t, m21 + _t, m22 + _t);
	}
	@Override
	public final DoubleMatrix33 		plus(final DoubleMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		return new DoubleMatrix33(m00 + _m.get(0,0), m01 + _m.get(0,1), m02 + _m.get(0,2),
							 m10 + _m.get(1,0), m11 + _m.get(1,1), m12 + _m.get(1,2),
							 m20 + _m.get(2,0), m21 + _m.get(2,1), m22 + _m.get(2,2));
	}

	@Override
	public final DoubleMatrix33 		plus(final Matrix33D _m) {
		return new DoubleMatrix33(m00 + _m.get(0,0), m01 + _m.get(0,1), m02 + _m.get(0,2),
							 m10 + _m.get(1,0), m11 + _m.get(1,1), m12 + _m.get(1,2),
							 m20 + _m.get(2,0), m21 + _m.get(2,1), m22 + _m.get(2,2));
	}
	...
	@Override
	public final DoubleMatrix33 		plusEquals(final Number _t) {
	...
	@Override
	public final DoubleMatrix33 		plusEquals(final NumberMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
	...
	@Override
	public final DoubleMatrix33 		plusEquals(final double _t) {
		m00 += _t; m01 += _t; m02 += _t;
		m10 += _t; m11 += _t; m12 += _t;
		m20 += _t; m21 += _t; m22 += _t;
		return this;
	...
	@Override
	public final DoubleMatrix33 		plusEquals(final DoubleMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		m00 += _m.get(0,0); m01 += _m.get(0,1); m02 += _m.get(0,2);
		m10 += _m.get(1,0); m11 += _m.get(1,1); m12 += _m.get(1,2);
		m20 += _m.get(2,0); m21 += _m.get(2,1); m22 += _m.get(2,2);
	...
	@Override
	public final DoubleMatrix33 		plusEquals(final Matrix33D _m) {
		m00 += _m.get(0,0); m01 += _m.get(0,1); m02 += _m.get(0,2);
		m10 += _m.get(1,0); m11 += _m.get(1,1); m12 += _m.get(1,2);
		m20 += _m.get(2,0); m21 += _m.get(2,1); m22 += _m.get(2,2);
		return this;
	...
	@Override
	public final DoubleMatrix33 		minus(final Number _t) {
		return new DoubleMatrix33(m00 - _t.doubleValue(), m01 - _t.doubleValue(), m02 - _t.doubleValue(),
							 m10 - _t.doubleValue(), m11 - _t.doubleValue(), m12 - _t.doubleValue(),
							 m20 - _t.doubleValue(), m21 - _t.doubleValue(), m22 - _t.doubleValue());
	}
	@Override
	public final DoubleMatrix33 		minus(final NumberMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		return new DoubleMatrix33(m00 - _m.getNumber(0,0).doubleValue(), m01 - _m.getNumber(0,1).doubleValue(), m02 - _m.getNumber(0,2).doubleValue(),
							 m10 - _m.getNumber(1,0).doubleValue(), m11 - _m.getNumber(1,1).doubleValue(), m12 - _m.getNumber(1,2).doubleValue(),
							 m20 - _m.getNumber(2,0).doubleValue(), m21 - _m.getNumber(2,1).doubleValue(), m22 - _m.getNumber(2,2).doubleValue());
	...
	@Override
	public final DoubleMatrix33 		minus(final double _t) {
		return new DoubleMatrix33(m00 - _t, m01 - _t, m02 - _t,
							 m10 - _t, m11 - _t, m12 - _t,
							 m20 - _t, m21 - _t, m22 - _t);
	}
	@Override
	public final DoubleMatrix33 		minus(final DoubleMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		return new DoubleMatrix33(m00 - _m.get(0,0), m01 - _m.get(0,1), m02 - _m.get(0,2),
							 m10 - _m.get(1,0), m11 - _m.get(1,1), m12 - _m.get(1,2),
							 m20 - _m.get(2,0), m21 - _m.get(2,1), m22 - _m.get(2,2));
	...
	@Override
	public final DoubleMatrix33 		minus(final Matrix33D _m) {
		return new DoubleMatrix33(m00 - _m.get(0,0), m01 - _m.get(0,1), m02 - _m.get(0,2),
							 m10 - _m.get(1,0), m11 - _m.get(1,1), m12 - _m.get(1,2),
							 m20 - _m.get(2,0), m21 - _m.get(2,1), m22 - _m.get(2,2));
	}
	...
	@Override
	public final DoubleMatrix33 		minusEquals(final Number _t) {
		m00 -= _t.doubleValue(); m01 -= _t.doubleValue(); m02 -= _t.doubleValue();
		m10 -= _t.doubleValue(); m11 -= _t.doubleValue(); m12 -= _t.doubleValue();
		m20 -= _t.doubleValue(); m21 -= _t.doubleValue(); m22 -= _t.doubleValue();
		return this;
	...
	@Override
	public final DoubleMatrix33 		minusEquals(final NumberMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		m00 -= _m.getNumber(0,0).doubleValue(); m01 -= _m.getNumber(0,1).doubleValue(); m02 -= _m.getNumber(0,2).doubleValue();
		m10 -= _m.getNumber(1,0).doubleValue(); m11 -= _m.getNumber(1,1).doubleValue(); m12 -= _m.getNumber(1,2).doubleValue();
		m20 -= _m.getNumber(2,0).doubleValue(); m21 -= _m.getNumber(2,1).doubleValue(); m22 -= _m.getNumber(2,2).doubleValue();
	...
	@Override
	public final DoubleMatrix33 		minusEquals(final double _t) {
		m00 -= _t; m01 -= _t; m02 -= _t;
		m10 -= _t; m11 -= _t; m12 -= _t;
		m20 -= _t; m21 -= _t; m22 -= _t;
		return this;
	...
	@Override
	public final DoubleMatrix33 		minusEquals(final DoubleMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
		m00 -= _m.get(0,0); m01 -= _m.get(0,1); m02 -= _m.get(0,2);
		m10 -= _m.get(1,0); m11 -= _m.get(1,1); m12 -= _m.get(1,2);
		m20 -= _m.get(2,0); m21 -= _m.get(2,1); m22 -= _m.get(2,2);
	...
	@Override
	public final DoubleMatrix33 		minusEquals(final Matrix33D _m) {
		m00 -= _m.get(0,0); m01 -= _m.get(0,1); m02 -= _m.get(0,2);
		m10 -= _m.get(1,0); m11 -= _m.get(1,1); m12 -= _m.get(1,2);
		m20 -= _m.get(2,0); m21 -= _m.get(2,1); m22 -= _m.get(2,2);
		return this;
	...
	@Override
	public final DoubleMatrix33 		times(final Number _v) {
		return new DoubleMatrix33(
	...
	public final NumberMatrix 			times(final NumberMatrix _m) {
		...
		DoubleMatrixMN result = new DoubleMatrixMN(3, _m.columns());
	...
	@Override
	public final DoubleMatrix33 		times(final double _v) {
		return new DoubleMatrix33(
	...
	@Override
	public final DoubleMatrixMN 		times(final DoubleMatrix _m) {
		assert(_m.rows() == 3);
...
*/
	...
	@Override
	public final DoubleMatrix33 		times(final Matrix33D _d) {
		return new DoubleMatrix33(
	...
	@Override
	public final DoubleMatrix33 		times(SquareMatrix _s) {
		return new DoubleMatrix33(this.times(_s));
	}

	@Override
	public final DoubleMatrix33 		timesEquals(final Number _v) {
		m00*=_v.doubleValue(); m01*=_v.doubleValue(); m02*=_v.doubleValue();
		m10*=_v.doubleValue(); m11*=_v.doubleValue(); m12*=_v.doubleValue();
		m20*=_v.doubleValue(); m21*=_v.doubleValue(); m22*=_v.doubleValue();
		return this;
	...
	@Override
	public final DoubleMatrix33 		timesEquals(final double _v) {
		m00*=_v; m01*=_v; m02*=_v;
		m10*=_v; m11*=_v; m12*=_v;
		m20*=_v; m21*=_v; m22*=_v;
		return this;
	...
	@Override
	public final DoubleMatrix33 		timesEquals(NumberMatrix _m) {
		m00*=_m.getNumber(0,0).doubleValue(); m01*=_m.getNumber(0,1).doubleValue(); m02*=_m.getNumber(0,2).doubleValue();
	...
	@Override
	public final DoubleMatrix33 		timesEquals(DoubleMatrix _m) {
		m00*=_m.getNumber(0,0).doubleValue(); m01*=_m.getNumber(0,1).doubleValue(); m02*=_m.getNumber(0,2).doubleValue();
		m10*=_m.getNumber(0,0).doubleValue(); m11*=_m.getNumber(0,1).doubleValue(); m12*=_m.getNumber(0,2).doubleValue();
		m20*=_m.getNumber(0,0).doubleValue(); m21*=_m.getNumber(0,1).doubleValue(); m22*=_m.getNumber(0,2).doubleValue();
		return this;
	...
	@Override
	public final DoubleMatrix33 		timesEquals(final SquareMatrix _m) {
		assert(_m.rows() == 3 && _m.columns() == 3);
...
//		return this;
	...
	@Override
	public final DoubleMatrix33 		timesEquals(final Matrix33D _d) {
		set(this.times(_d));
		return this;
	}

	@Override
	public final DoubleMatrix33 		arrayTimes(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(m00*B.getNumber(0, 0).doubleValue(), m01*B.getNumber(0, 1).doubleValue(), m02*B.getNumber(0, 2).doubleValue(),
	...
	@Override
	public final DoubleMatrix33 		arrayTimes(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(m00*B.get(0, 0), m01*B.get(0, 1), m02*B.get(0, 2),
	...
	@Override
	public final DoubleMatrix33 		arrayTimesEquals(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
	...
	@Override
	public final DoubleMatrix33 		arrayTimesEquals(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		m00 *= B.get(0, 0);
		m01 *= B.get(0, 1);
		m02 *= B.get(0, 2);
	...
	@Override
	public final DoubleMatrix33 		arrayRightDivide(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(m00/B.getNumber(0, 0).doubleValue(), m01/B.getNumber(0, 1).doubleValue(), m02/B.getNumber(0, 2).doubleValue(),
							 m10/B.getNumber(1, 0).doubleValue(), m11/B.getNumber(1, 1).doubleValue(), m12/B.getNumber(1, 2).doubleValue(),
							 m20/B.getNumber(2, 0).doubleValue(), m21/B.getNumber(2, 1).doubleValue(), m22/B.getNumber(2, 2).doubleValue()
	...
	@Override
	public final DoubleMatrix33 		arrayRightDivide(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(m00/B.get(0, 0), m01/B.get(0, 1), m02/B.get(0, 2),
							 m10/B.get(1, 0), m11/B.get(1, 1), m12/B.get(1, 2),
							 m20/B.get(2, 0), m21/B.get(2, 1), m22/B.get(2, 2)
	...
	@Override
	public final DoubleMatrix33 		arrayRightDivideEquals(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		m00 /= B.getNumber(0, 0).doubleValue();
		m01 /= B.getNumber(0, 1).doubleValue();
		m02 /= B.getNumber(0, 2).doubleValue();
	...
	@Override
	public final DoubleMatrix33 		arrayRightDivideEquals(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		m00 /= B.get(0, 0);
		m01 /= B.get(0, 1);
		m02 /= B.get(0, 2);
	...
	@Override
	public final DoubleMatrix33 		arrayLeftDivide(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(B.getNumber(0, 0).doubleValue()/m00, B.getNumber(0, 1).doubleValue()/m01, B.getNumber(0, 2).doubleValue()/m02,
	...
	@Override
	public final DoubleMatrix33 		arrayLeftDivide(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		return new DoubleMatrix33(B.get(0, 0)/m00, B.get(0, 1)/m01, B.get(0, 2)/m02,
	...
	@Override
	public final DoubleMatrix33 		arrayLeftDivideEquals(final NumberMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
	...
	@Override
	public final DoubleMatrix33 		arrayLeftDivideEquals(final DoubleMatrix B) {
		assert(B.rows() == 3 && B.columns() == 3);
		m00 = B.get(0, 0) / m00;
		m01 = B.get(0, 1) / m01;
		m02 = B.get(0, 2) / m02;
	...
	@Override
	public final DoubleMatrix33 		clone() {
		return new DoubleMatrix33(m00, m01, m02, m10, m11, m12, m20, m21, m22);
	}
	@Override
	public final DoubleMatrix33 		abs() {
		return new DoubleMatrix33(Math.abs(m00), Math.abs(m01), Math.abs(m02), Math.abs(m10), Math.abs(m11), Math.abs(m12), Math.abs(m20), Math.abs(m21), Math.abs(m22));
	}
	@Override
	public final DoubleMatrix33 		inverse() {
		double det = det();
		if(det != 0.0f)
			det = 1.0f / det;
		...
		return new DoubleMatrix33(  	det * (a22 * a33 - a23 * a23),
								det * (a22 * a33 - a23 * a23),
								det * (a22 * a33 - a23 * a23),
	...
	@Override
	public final DoubleMatrix33 		transpose() {
		return new DoubleMatrix33(m00, m10, m20, m01, m11, m21, m02, m12, m22);
	}
	@Override
	public final DoubleMatrix33 		uminus() {
		return new DoubleMatrix33(-m00, -m01, -m02, -m10, -m11, -m12, -m20, -m21, -m22);
	}
	...
	public boolean equals(Object _obj) {
		...
		if(getClass() != _obj.getClass())
			return false;
		DoubleMatrix33 other = (DoubleMatrix33) _obj;
