...
public class DoubleVectorND implements DoubleVector.Editable, NumberVector.Editable {
	private static final long serialVersionUID = -3073045430773729265L;

	private static final double EPSILON = 0;

	public static final DoubleVectorND allocate(final int _n) {
		DoubleVectorND V = new DoubleVectorND();

		V.data = new double[_n];

		return V;
	}
	public static final DoubleVectorND allocate(final double[] _values) {
		DoubleVectorND V = new DoubleVectorND();
	...
	public static final DoubleVectorND wrap(final double[] _values) {
		DoubleVectorND V = new DoubleVectorND();
	...
	public static final double dot(final DoubleVectorND _a, final DoubleVectorND _b) {
	...
	private DoubleVectorND() {
		;
	}
	public DoubleVectorND(final double _value) {
		data = new double[1];
		data[0] = _value;
	}
	public DoubleVectorND(final int _size) {
		data = new double[_size];
	}
	public DoubleVectorND(final int _size, final double _value) {
		data = new double[_size];
		for (int i = 0; i < data.length; i++)
			data[i] = _value;
	}
	public DoubleVectorND(final int _size, final double[] _values) {
		data = new double[_size];
		System.arraycopy(_values, 0, data, 0, Math.min(_size, _values.length));
	}
	public DoubleVectorND(final int _size, final DoubleVectorND _vector) {
		data = new double[_size];
		System.arraycopy(_vector.data, 0, data, 0, Math.min(_size, _vector.data.length));
	}
	private DoubleVectorND(final double[] _values) {
		data = new double[_values.length];
		System.arraycopy(_values, 0, data, 0, _values.length);
	}
	public DoubleVectorND(final DoubleVectorND _vector) {
		data = new double[_vector.data.length];
		System.arraycopy(_vector.data, 0, data, 0, _vector.data.length);
	}
	public DoubleVectorND(final NumberVector _vector) {
	...
	**/
	...
	public final void 			set(final DoubleVectorND _vector) {
	...
	public final DoubleVectorND 		plus(final Number _d) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] + _d.doubleValue();
		return new DoubleVectorND(v.length, v);
	}
	public final DoubleVectorND 		plus(final Number[] _d) {
	...
	public final DoubleVectorND 		plus(final NumberVector _v) {
	...
	public final DoubleVectorND 		plus(final double _d) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] + _d;
		return new DoubleVectorND(v.length, v);
	...
	public final DoubleVectorND 		plus(final DoubleVector _v) {
		assert (data.length == _v.size());
		double[] v = new 	double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] + _v.get(i);
	...
	public final DoubleVectorND 		plus(final DoubleVectorND _v) {
	...
	public final DoubleVectorND 		plusEquals(final Number _d) {
		for(int i = 0; i < data.length; ++i)
	...
	public final DoubleVectorND 		plusEquals(final NumberVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
	...
	public final DoubleVectorND 		plusEquals(final double _d) {
		for(int i = 0; i < data.length; ++i)
			data[i] += _d;
		return this;
	}
	...
	public final DoubleVectorND 		plusEquals(final DoubleVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] += _v.get(i);
		return this;
	...
	public final DoubleVectorND 		plusEquals(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		for(int i = 0; i < data.length; ++i)
			data[i] += _v.data[i];
		return this;
	...
	public final DoubleVectorND 		minus(final Number _d) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] - _d.doubleValue();
		return new DoubleVectorND(v.length, v);
	...
	public final DoubleVectorND 		minus(final NumberVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] - _v.getNumber(i).doubleValue();
		return new DoubleVectorND(v);
	}
	
	public final DoubleVectorND 		minus(final double _d) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] - _d;
		return new DoubleVectorND(v.length, v);
	...
	public final DoubleVectorND 		minus(final DoubleVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] - _v.get(i);
	...
	public final DoubleVectorND 		minus(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] - _v.data[i];
	...
	public final DoubleVectorND 		minusEquals(final Number _d) {
		for(int i = 0; i < data.length; ++i)
			data[i] -= _d.doubleValue();
		return this;
	}
	...
	public final DoubleVectorND 		minusEquals(final NumberVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] -= _v.getNumber(i).doubleValue();
		return this;
	...
	public final DoubleVectorND 		minusEquals(final double _d) {
		for(int i = 0; i < data.length; ++i)
			data[i] -= _d;
		return this;
	}
	...
	public final DoubleVectorND 		minusEquals(final DoubleVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] -= _v.get(i);
		return this;
	...
	public final DoubleVectorND 		minusEquals(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		for(int i = 0; i < data.length; ++i)
			data[i] -= _v.data[i];
		return this;
	...
	public final DoubleVectorND 		times(final Number _t) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _t.doubleValue();
		return new DoubleVectorND(data.length, v);
	}
	public final DoubleVectorND 		times(final Number[] _d) {
		assert (data.length == _d.length);
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _d[i].doubleValue();
	...
	public final DoubleVectorND 		times(final NumberVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _v.getNumber(i).doubleValue();
	...
	public final DoubleVectorND 		times(final double _t) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _t;
		return new DoubleVectorND(data.length, v);
	}
	public final DoubleVectorND 		times(final double[] _d) {
		assert (data.length == _d.length);
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _d[i];
	...
	public final DoubleVectorND 		times(final DoubleVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _v.get(i);
	...
	public final DoubleVectorND 		times(final DoubleVectorND _v) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] * _v.data[i];
		return new DoubleVectorND(data.length, v);
	...
	public final DoubleVectorND 		timesEquals(final Number _t) {
		for(int i = 0; i < data.length; ++i)
			data[i] *= _t.doubleValue();
		return this;
	}
	public final DoubleVectorND 		timesEquals(final Number[] _d) {
		assert (data.length == _d.length);
		for(int i = 0; i < data.length; ++i)
			data[i] *= _d[i].doubleValue();
		return this;
	}
	public final DoubleVectorND 		timesEquals(final NumberVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] *= _v.getNumber(i).doubleValue();
		return this;
	...
	public final DoubleVectorND	 	timesEquals(final double _t) {
		for(int i = 0; i < data.length; ++i)
			data[i] *= _t;
		return this;
	}
	public final DoubleVectorND 		timesEquals(final double[] _d) {
		assert (data.length == _d.length);
		for(int i = 0; i < data.length; ++i)
			data[i] *= _d[i];
		return this;
	}
	public final DoubleVectorND 		timesEquals(final DoubleVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] *= _v.get(i);
		return this;
	...
	public final DoubleVectorND 		timesEquals(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		for(int i = 0; i < data.length; ++i)
			data[i] *= _v.data[i];
		return this;
	...
	public final DoubleVectorND 		divides(final Number _t) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _t.doubleValue();
		return new DoubleVectorND(data.length, v);
	}
	public final DoubleVectorND 		divides(final Number[] _d) {
		assert (data.length == _d.length);
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _d[i].doubleValue();
	...
	public final DoubleVectorND 		divides(final NumberVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _v.getNumber(i).doubleValue();
	...
	public final DoubleVectorND	 	divides(final double _t) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _t;
		return new DoubleVectorND(data.length, v);
	}
	public final DoubleVectorND 		divides(final double[] _d) {
		assert (data.length == _d.length);
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _d[i];
	...
	public final DoubleVectorND 		divides(final DoubleVector _v) {
		assert (data.length == _v.size());
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _v.get(i);
	...
	public final DoubleVectorND 		divides(final DoubleVectorND _v) {
		double[] v = new double[data.length];
		for(int i = 0; i < data.length; ++i)
			v[i] = data[i] / _v.data[i];
		return new DoubleVectorND(data.length, v);
	...
	public final DoubleVectorND 		dividesEquals(final Number _t) {
		for(int i = 0; i < data.length; ++i)
			data[i] /= _t.doubleValue();
		return this;
	}
	public final DoubleVectorND 		dividesEquals(final Number[] _d) {
		assert (data.length == _d.length);
		for(int i = 0; i < data.length; ++i)
			data[i] /= _d[i].doubleValue();
		return this;
	}
	public final DoubleVectorND 		dividesEquals(final NumberVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] /= _v.getNumber(i).doubleValue();
		return this;
	...
	public final DoubleVectorND	 	dividesEquals(final double _t) {
		for(int i = 0; i < data.length; ++i)
			data[i] /= _t;
		return this;
	}
	public final DoubleVectorND 		dividesEquals(final double[] _d) {
		assert (data.length == _d.length);
		for(int i = 0; i < data.length; ++i)
			data[i] /= _d[i];
		return this;
	}
	public final DoubleVectorND 		dividesEquals(final DoubleVector _v) {
		assert (data.length == _v.size());
		for(int i = 0; i < data.length; ++i)
			data[i] /= _v.get(i);
		return this;
	...
	public final DoubleVectorND 		dividesEquals(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		for(int i = 0; i < data.length; ++i)
			data[i] /= _v.data[i];
		return this;
	...
	public final boolean 		isEqual(final DoubleVectorND _v) {
		assert (data.length == _v.data.length);
		for(int i = 0; i < data.length; ++i)
			if(data[i] != _v.data[i])
				return false;
	...
	public final boolean 		isDifferent(final DoubleVectorND _d) {
		return !isEqual(_d);
	}
	...
	public final boolean 		isOrthogonal(final DoubleVectorND _vec) {
		return (dot(this, _vec) < EPSILON) ? true : false;
	}

	@Override
	public final DoubleVectorND 		clone() {
		return new DoubleVectorND(data.length, data);
	}
	@Override
	public DoubleVector.Editable 		cloneEditable() {
		return new DoubleVectorND(data.length, data);
	}
	@Override
	public final DoubleVectorND 		abs() {
		for (double v : data)
			v = Math.abs(v);
		return this;
	}
	@Override
	public final DoubleVectorND 		negate() {
		for (double v : data)
			v = -v;
		return this;
	}
	@Override
	public final DoubleVectorND 		normalized() {
		double length = norm();
		if (length < EPSILON)
			return this;
...
*/
	...
	public final double 		dotProduct(final DoubleVectorND _v) {
/*
		assert(data.length == _v.data.length);
		double sum = 0;
...
*/
	...
	public final boolean 		equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoubleVectorND other = (DoubleVectorND) obj;
		for (int i = 0; i < data.length; ++i)
