...
public class Lines {
	public Line2D NaN = new Line2D() {
		...
		public Point2D getPoint() 											{ return new DoubleVector2D(Double.NaN,  Double.NaN); }
		public Point2D getPoint(boolean _random) 							{ return new DoubleVector2D(Double.NaN,  Double.NaN); }
