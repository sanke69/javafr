...
import fr.java.maths.geometry.space.types.SimpleVector4D;
...
public abstract class AdapterVectorDouble implements DoubleVector {
	...
	protected AdapterVectorDouble(int _nbDimension) {
		super();
	...
	public DoubleVector 	plus(DoubleVector _vector) {
		...
		case 4  :   if(_vector.size() < 4)
					...
					return new SimpleVector4D(v4.getX()+_vector.get(0), v4.getY()+_vector.get(1), v4.getZ()+_vector.get(2), v4.getW()+_vector.get(3));
		case 3  :   if(_vector.size() < 3)
						throw new IllegalArgumentException();
					Vector3D v3 = (Vector3D) this;
					return new SimpleVector3D(v3.getX()+_vector.get(0), v3.getY()+_vector.get(1), v3.getZ()+_vector.get(2));
		case 2  :   if(_vector.size() < 2)
						throw new IllegalArgumentException();
					Vector2D v2 = (Vector2D) this;
					return new SimpleVector2D(v2.getX()+_vector.get(0), v2.getY()+_vector.get(1));
		case 1  :   if(_vector.size() < 2)
						throw new IllegalArgumentException();
					Vector1D v1 = (Vector1D) this;
					return new SimpleVector1D(v1.getX()+_vector.get(0));
	...
	public NumberVector 	plus(NumberVector _vector) {
		...
		case 4  :   if(_vector.size() < 4)
						throw new IllegalArgumentException();
					Vector4D v4 = (Vector4D) this;
					return new SimpleVector4D(v4.getX()+_vector.getNumber(0).doubleValue(), v4.getY()+_vector.getNumber(1).doubleValue(), v4.getZ()+_vector.getNumber(2).doubleValue(), v4.getW()+_vector.getNumber(3).doubleValue());
		case 3  :   if(_vector.size() < 3)
						throw new IllegalArgumentException();
					Vector3D v3 = (Vector3D) this;
					return new SimpleVector3D(v3.getX()+_vector.getNumber(0).doubleValue(), v3.getY()+_vector.getNumber(1).doubleValue(), v3.getZ()+_vector.getNumber(2).doubleValue());
		case 2  :   if(_vector.size() < 2)
						throw new IllegalArgumentException();
					Vector2D v2 = (Vector2D) this;
					return new SimpleVector2D(v2.getX()+_vector.getNumber(0).doubleValue(), v2.getY()+_vector.getNumber(1).doubleValue());
		case 1  :   if(_vector.size() < 2)
						throw new IllegalArgumentException();
					Vector1D v1 = (Vector1D) this;
					return new SimpleVector1D(v1.getX()+_vector.getNumber(0).doubleValue());
		default :   throw new IllegalArgumentException("What The Fuck");
		}
	}
	...
	public static abstract class Editable extends AdapterVectorDouble implements DoubleVector.Editable {
		...
		protected Editable(int _nbDimension) {
			super(_nbDimension);
		}
