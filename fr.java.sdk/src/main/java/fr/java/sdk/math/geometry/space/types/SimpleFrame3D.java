package fr.java.sdk.math.geometry.space.types;
...
public class SimpleFrame3D implements Frame3D {
	...
	public SimpleFrame3D() {
		super();
		o = Geometry.Space.WorldOrigin.clone();
		i = Geometry.Space.WorldXAxis.clone();
		j = Geometry.Space.WorldYAxis.clone();
		k = Geometry.Space.WorldZAxis.clone();
	...
	public SimpleFrame3D(Point3D _o, Vector3D _i, Vector3D _j, Vector3D _k) {
		super();
		o = _o.clone();
		i = _i.normalized().clone();
		j = _j.normalized().clone();
		k = _k.normalized().clone();
