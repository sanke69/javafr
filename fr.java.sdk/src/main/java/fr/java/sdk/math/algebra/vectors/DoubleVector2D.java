...
public class DoubleVector2D implements Point2D.Editable, Vector2D.Editable {
	...
	**/
	@Override
	public DoubleVector3D 			uniform() 						{ return new DoubleVector3D(getX(), getY(), 0.0d); }
	@Override
	public DoubleVector3D 			uniform(double _w) 				{ return new DoubleVector3D(getX(), getY(), _w); }
	...
	@Override
	public Vector2D 			plus(Number _x, Number _y) {
	...
	@Override
	public Vector2D minus(Number _x, Number _y) {
		return new DoubleVector2D(x - _x.doubleValue(), y - _y.doubleValue());
	}
	@Override
	...
	@Override
	public Vector2D times(Number _x, Number _y) {
		return new DoubleVector2D(x * _x.doubleValue(), y * _y.doubleValue());
	}
	@Override
	...
	public final DoubleVector2D 		times(final Point2D _d) {
		return new DoubleVector2D(x * _d.getX(), y * _d.getY());
	}
	...
	public final DoubleVector2D 		timesEquals(final Point2D _d) {
		x *= _d.getX();
		y *= _d.getY();
		return this;
	}
	...
	public final DoubleVector2D 		divides(final Point2D _d) {
	...
	public final DoubleVector2D 		dividesEquals(final Point2D _d) {
		if(_d.getX() == 0 || _d.getY() == 0) throw new RuntimeException("Divide by 0");
		x /= _d.getX();
		y /= _d.getY();
		return this;
