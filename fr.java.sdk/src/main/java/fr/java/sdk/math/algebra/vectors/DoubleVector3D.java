...
public class DoubleVector3D implements DoubleVector.Editable, Point3D.Editable, Vector3D.Editable {
	...
	**/
	...
	@Override
	public final Number 		getNumber(long _index) {
	...
	@Override
	public final double 		getValue(long _index) {
		switch((int) _index) {
		case 0  : return x;
		case 1  : return y;
		case 2  : return z;
	...
	@Override
	public final void 			setValue(double _value, long _index) {
		switch((int) _index) {
		case 0  : x = _value;
		case 1  : y = _value;
		case 2  : z = _value;
	...
	**/
	@Override
	public final DoubleVector2D 		as2D() {	// TODO:: Check
//		if(z != 0)
//			return new Vector2d(x / z, y / z);
	...
	@Override
	public final DoubleVector4D 		uniform() {
		return new DoubleVector4D(getX(), getY(), getZ(), 0.0d);
	}
	@Override
	public final DoubleVector4D 		uniform(final double _w) {
	...
	public final DoubleVector3D 		times(final Point3D _d) {
		return new DoubleVector3D(x*_d.getX(), y*_d.getY(), z*_d.getZ());
	}
	@Override
	...
	public final DoubleVector3D 		timesEquals(final Point3D _d) {
		x *= _d.getX();
		y *= _d.getY();
		z *= _d.getZ();
		return this;
	...
	public final DoubleVector3D 		divides(final Point3D _other) {
	...
	@Override
	public final boolean 		isColinear(final double _x, final double _y, final double _z) {
		return (x * _x) == (y * _y) && (x * _x) == (z * _z);
	}
	@Override
	...
	@Override
	public final boolean 		isOrthogonal(final double _x, final double _y, final double _z) {
		double dotProd = getX() * _x + getY() * _y + getZ() * _z;
		return (dotProd < Numbers.EPSILON) ? true : false;
