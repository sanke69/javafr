...
public class Cube3D implements BoundingBox3D.Editable {
	private static final long serialVersionUID = -4298538292966277165L;

	public static Cube3D empty() {
		return new Cube3D(0, 0, 0, 0, 0, 0);
	}
	public static Cube3D unit() {
		return new Cube3D(0, 0, 0, 1, 1, 1);
	}

	public static Cube3D of(double _x, double _y, double _z, double _w, double _h, double _d) {
		return new Cube3D(_x, _y, _z, _w, _h, _d);
	}
	...
	public Cube3D(double _width, double _height, double _depth) {
		this();
		width = _width;
		height = _height;
		depth = _depth;
	}
	public Cube3D(Dimension3D _dimensions) {
		this(_dimensions.getWidth(), _dimensions.getHeight(), _dimensions.getDepth());
	}
	public Cube3D(double _x, double _y, double _z, double _width, double _height, double _depth) {
		super();
		minX = _x;
		minY = _y;
		minZ = _z;
	...
	public Cube3D(Set<Point3D> _points) {
	...
	public Cube3D(Point3DBufferX _points) {
...
//	@Override
	...
	*/
	...
	@Override
	public Cube3D clone() {
		return new Cube3D(minX, minY, minZ, width, height, depth);
	}
