...
public class PatternFileFilter implements FileFilter {
	...
	public PatternFileFilter(Pattern _include, Pattern _exclude) {
		include   = _include;
		exclude   = _exclude;
		recursive = false;
	}
	public PatternFileFilter(Pattern _include, Pattern _exclude, boolean _recursive) {
		include   = _include;
		exclude   = _exclude;
	...
	public boolean test(File _file) {
		return isIncluded(new FileObject(_file));
	}
