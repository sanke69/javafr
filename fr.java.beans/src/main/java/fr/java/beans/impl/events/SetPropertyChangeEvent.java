 ...
 *
 * @file     SetPropertyChangeEvent.java
 * @version  0.0.0.1
 * @date     2017/04/27
 * 
**/
...
public class SetPropertyChangeEvent<E> extends PropertyChangeEvent {
	...
	public SetPropertyChangeEvent(Object source, String propertyName, Change<E> _changes) {
