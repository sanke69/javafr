...
public /*abstract*/ class BeanPropertySetAdapter<T> extends BeanPropertySet<T> implements BeanProperty<Set<T>>, Set<T> {
	...
	public BeanPropertySetAdapter(BeanPropertySet<T> _setProperty) {
		this(null, "setProperty", _setProperty);
	}
	public BeanPropertySetAdapter(String _propertyName, BeanPropertySet<T> _setProperty) {
		this(null, _propertyName, _setProperty);
	}
	public BeanPropertySetAdapter(Object _bean, String _propertyName, BeanPropertySet<T> _setProperty) {
	 ...
	 */
	public BeanPropertySetAdapter(BeanPropertyList<T> _listProperty) {
		this(null, "setProperty", _listProperty);
	}
	public BeanPropertySetAdapter(String _propertyName, BeanPropertyList<T> _listProperty) {
		this(null, _propertyName, _listProperty);
	}
	public BeanPropertySetAdapter(Object _bean, String _propertyName, BeanPropertyList<T> _listProperty) {
		super(_bean, _propertyName, null);
...
//						System.out.println("REMOVE " + i + "(" + _changes.getFrom() + ")" );
	 ...
	 * DO NOT RESPECT 'SET' DESIGN PATTERN
	 */
	public BeanPropertySetAdapter(BeanPropertyCollection<T> _collectionProperty) {
		this(null, "setProperty", _collectionProperty);
	}
	public BeanPropertySetAdapter(String _propertyName, BeanPropertyCollection<T> _collectionProperty) {
		this(null, _propertyName, _collectionProperty);
	}
	public BeanPropertySetAdapter(Object _bean, String _propertyName, BeanPropertyCollection<T> _collectionProperty) {
		super(_bean, _propertyName, null);
