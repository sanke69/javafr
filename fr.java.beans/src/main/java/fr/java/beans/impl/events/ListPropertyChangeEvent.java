 ...
 *
 * @file     ListPropertyChangeEvent.java
 * @version  0.0.0.1
 * @date     2017/04/27
 * 
**/
...
public class ListPropertyChangeEvent<E> extends PropertyChangeEvent {
	...
	public ListPropertyChangeEvent(Object source, String propertyName, Change<E> _changes) {
