...
public @interface BeanPropertyField {
	...
	public String  description()	default BeanPropertyTag.NO_DESCRIPTION;

	public String  setter()			default BeanPropertyTag.DEFAULT;
	public String  getter()			default BeanPropertyTag.DEFAULT;
