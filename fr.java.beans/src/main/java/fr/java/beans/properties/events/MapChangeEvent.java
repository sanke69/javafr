 ...
 *
 * @file     MapPropertyChangeEvent.java
 * @version  0.0.0.1
 * @date     2017/04/27
 * 
**/
...
public class MapChangeEvent<K, V> extends PropertyChangeEvent {
	...
	public MapChangeEvent(Object source, String propertyName, Change<K, V> _change) {
